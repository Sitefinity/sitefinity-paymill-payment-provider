...
namespace Telerik.Sitefinity.Samples.Ecommerce.Paymill
{
    public class PaymillSettingsField : FieldControl
    {
        ...
        /// </summary>
        protected virtual TextField TestGatewayUrlControl
        {
            get
            {
                return this.Container.GetControl<TextField>("testGatewayUrl", true);
            }
        }
        ...
        /// <summary>
        /// Gets the reference to the control that holds the live gateway url of the payment processor.
        /// </summary>
        protected virtual TextField LiveGatewayUrlControl
        {
            get
            {
                return this.Container.GetControl<TextField>("liveGatewayUrl", true);
            }
        }
        ...
        public override IEnumerable<ScriptDescriptor> GetScriptDescriptors()
        {
            ...
            descriptor.AddComponentProperty("testGatewayUrlControl", this.TestGatewayUrlControl.ClientID);
            ...
            descriptor.AddComponentProperty("liveGatewayUrlControl", this.LiveGatewayUrlControl.ClientID);
        ...
        internal const string scriptReference = "Telerik.Sitefinity.Samples.Ecommerce.Paymill.PaymillSettingsField.js";
        private const string layoutTemplateName = "Telerik.Sitefinity.Samples.Ecommerce.Paymill.PaymillSettingsField.ascx";
