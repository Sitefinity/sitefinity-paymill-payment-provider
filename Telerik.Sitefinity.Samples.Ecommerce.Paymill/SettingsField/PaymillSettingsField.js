...
Telerik.Sitefinity.Samples.Ecommerce.Paymill.PaymillSettingsField.prototype = {
    ...
    validate: function () {
        ...
        if (this.get_processingModeControl().get_value() == "live") {
            ...
            if (!this.get_liveGatewayUrlControl().validate()) {
                isValid = false;
            }
            ...
            if (!this.get_testGatewayUrlControl().validate()) {
                isValid = false;
            }
    ...
    reset: function () {
        ...
        this._state = { 'TestGatewayURL': '', 'TestPrivateApiKey': '', 'TestPublicApiKey': '', 'LiveGatewayURL': '', 'LivePrivateApiKey': '', 'LivePublicApiKey': '', 'Timeout': '30000', 'ProcessingMode': '', 'ProcessorCreditCards': undefined, 'PaymentType': '' };
    },
    ...
    _updateUI: function () {
        this.get_testGatewayUrlControl().set_value(this._state.TestGatewayUrl);
        ...
        this.get_liveGatewayUrlControl().set_value(this._state.LiveGatewayUrl);
    ...
    // gets the reference to the control that holds the test url of the payment processor
    get_testGatewayUrlControl: function () {
        return this._testGatewayUrlControl;
    },
    // sets the reference to the control that holds the test url of the payment processor
    set_testGatewayUrlControl: function (value) {
        this._testGatewayUrlControl = value;
    },
    ...
    // gets the reference to the control that holds the live url of the payment processor
    get_liveGatewayUrlControl: function () {
        return this._liveGatewayUrlControl;
    },
    // sets the reference to the control that holds the live url of the payment processor
    set_liveGatewayUrlControl: function (value) {
        this._liveGatewayUrlControl = value;
    },
